...
def generate_launch_description():
    test_robot_description_share = FindPackageShare(package='assignment2').find('assignment2')
    default_model_path = os.path.join(test_robot_description_share, 'urdf/robot7.xacro')
